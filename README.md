...
Training and Evaluation CER can be plotted using matplotlib. 
A Makefile is provided `plot` subdirectory to do the plotting.
The training log needs to be saved in `plot/MODEL_NAME.LOG`.
